...
icon = Image.open('C:\python fs\converter image.jpeg')
...
to_label = Label(main, text = "To", width=8, height=
                 1, pady=0, padx=0, relief="flat", anchor=NW, font=('Ivy 10 bold'), bg=cor0, fg=cor1)
...
button = Button(main, text="Converter", width=19, padx=5, height=1, bg=cor3, fg=cor0,font=("Ivy 12 bold"), command=convert)
